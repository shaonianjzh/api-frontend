...
/** getUserKey GET /api/user/getUserKey */
export async function getUserKeyUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserKeyVo_>('/api/user/getUserKey', {
    method: 'GET',
    ...(options || {}),
  });
}
